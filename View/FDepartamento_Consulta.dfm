object Departamento_Consulta: TDepartamento_Consulta
  ...
  object DSP: TDataSetProvider
    DataSet = FDQDepartamentos_Consulta
    Left = 392
    Top = 271
  end
  object FDQDepartamentos_Consulta: TFDQuery
    Connection = DM_Conexao.FDConnection
    SQL.Strings = (
      'SELECT '
      ' D.id_departamento,'
      ' D.nm_departamento,'
    ...
    Left = 288
    Top = 272
    object FDQDepartamentos_Consultaid_departamento: TIntegerField
      FieldName = 'id_departamento'
      Origin = 'id_departamento'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object FDQDepartamentos_Consultanm_departamento: TWideStringField
      FieldName = 'nm_departamento'
      Origin = 'nm_departamento'
      Size = 100
    end
    object FDQDepartamentos_Consultalocal: TWideStringField
      FieldName = 'local'
      Origin = '"local"'
      Size = 100
    end
